...
extension StargateKitRequest.ListeReponse {
    ...
    public enum GetMAE2 {
        ...
        public static let service = APIService<Response>(id: "getMAE2", tag: "Liste reponse", method: "GET", path: "/getMAE2", hasBody: false)
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: GetMAE2.service)
            }
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            public typealias SuccessType = SKRResMAE2

            /** OK - successful operation */
            case status200(SKRResMAE2)

            /** Internal Server Error */
            case status500(SKRException)

            public var success: SKRResMAE2? {
                switch self {
            ...
            public var responseResult: APIResponseResult<SKRResMAE2, SKRException> {
            ...
            public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
                switch statusCode {
                case 200: self = try .status200(decoder.decode(SKRResMAE2.self, from: data))
