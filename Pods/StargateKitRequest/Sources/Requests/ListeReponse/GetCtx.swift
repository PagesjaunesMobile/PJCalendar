...
extension StargateKitRequest.ListeReponse {
    ...
    /**
    Récupérer la liste réponses paginée ou filtrée d'une recherche précédente

    Exemple = "/getCtx
    */
    public enum GetCtx {

        public static let service = APIService<Response>(id: "getCtx", tag: "Liste reponse", method: "GET", path: "/getCtx", hasBody: false)
        ...
        public final class Request: APIRequest<Response> {
            ...
            public struct Options {
                ...
                /** Numéro de page */
                public var pageNb: Int

                public init(token: String? = nil, what: String? = nil, placeCode: String? = nil, mnemo: String? = nil, type: String? = nil, `where`: String? = nil, coordinates: String? = nil, proximity: Bool? = nil, filter: String? = nil, sort: String? = nil, everywhere: Bool? = nil, denom: Bool? = nil, count: Bool? = nil, mode: String? = nil, indexSuggestion: Int? = nil, suggestionType: String? = nil, dateHeureReservation: String? = nil, nbPersonnesReservation: String? = nil, ctxId: String, pageNb: Int) {
                    self.token = token
                    self.what = what
            ...
            public init(options: Options) {
                ...
                super.init(service: GetCtx.service)
            }

            /// convenience initialiser so an Option doesn't have to be created
            public convenience init(token: String? = nil, what: String? = nil, placeCode: String? = nil, mnemo: String? = nil, type: String? = nil, `where`: String? = nil, coordinates: String? = nil, proximity: Bool? = nil, filter: String? = nil, sort: String? = nil, everywhere: Bool? = nil, denom: Bool? = nil, count: Bool? = nil, mode: String? = nil, indexSuggestion: Int? = nil, suggestionType: String? = nil, dateHeureReservation: String? = nil, nbPersonnesReservation: String? = nil, ctxId: String, pageNb: Int) {
                let options = Options(token: token, what: what, placeCode: placeCode, mnemo: mnemo, type: type, `where`: `where`, coordinates: coordinates, proximity: proximity, filter: filter, sort: sort, everywhere: everywhere, denom: denom, count: count, mode: mode, indexSuggestion: indexSuggestion, suggestionType: suggestionType, dateHeureReservation: dateHeureReservation, nbPersonnesReservation: nbPersonnesReservation, ctxId: ctxId, pageNb: pageNb)
            ...
            public override var parameters: [String: Any] {
                ...
                params["pageNb"] = options.pageNb
                return params
            }
        }

        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            public typealias SuccessType = SKRResCtx

            /** OK */
            case status200(SKRResCtx)

            /** Internal Server Error */
            case status500(SKRException)

            public var success: SKRResCtx? {
                switch self {
            ...
            public var responseResult: APIResponseResult<SKRResCtx, SKRException> {
            ...
            public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
                switch statusCode {
                case 200: self = try .status200(decoder.decode(SKRResCtx.self, from: data))
