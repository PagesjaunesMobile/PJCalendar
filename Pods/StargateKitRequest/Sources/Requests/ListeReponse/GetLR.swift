...
extension StargateKitRequest.ListeReponse {
    ...
    /**
    Récupérer la liste réponses d'une recherche

    Exemple = "/getLR?what=resto&where=rennes. Il n'y a pas de paramètres obligatoire. Cependant plusieurs combinaisons son possible avec les coordonnées et le mnemo etc ...
    */
    public enum GetLR {

        public static let service = APIService<Response>(id: "getLR", tag: "Liste reponse", method: "GET", path: "/getLR", hasBody: false)
        ...
        public final class Request: APIRequest<Response> {
            ...
            public struct Options {
                ...
                public init(token: String? = nil, what: String? = nil, placeCode: String? = nil, mnemo: String? = nil, type: String? = nil, `where`: String? = nil, coordinates: String? = nil, proximity: Bool? = nil, filter: String? = nil, sort: String? = nil, everywhere: Bool? = nil, denom: Bool? = nil, count: Bool? = nil, mode: String? = nil, indexSuggestion: Int? = nil, suggestionType: String? = nil, dateHeureReservation: String? = nil, nbPersonnesReservation: String? = nil) {
                    self.token = token
                    self.what = what
            ...
            public init(options: Options) {
                ...
                super.init(service: GetLR.service)
            }

            /// convenience initialiser so an Option doesn't have to be created
            public convenience init(token: String? = nil, what: String? = nil, placeCode: String? = nil, mnemo: String? = nil, type: String? = nil, `where`: String? = nil, coordinates: String? = nil, proximity: Bool? = nil, filter: String? = nil, sort: String? = nil, everywhere: Bool? = nil, denom: Bool? = nil, count: Bool? = nil, mode: String? = nil, indexSuggestion: Int? = nil, suggestionType: String? = nil, dateHeureReservation: String? = nil, nbPersonnesReservation: String? = nil) {
                let options = Options(token: token, what: what, placeCode: placeCode, mnemo: mnemo, type: type, `where`: `where`, coordinates: coordinates, proximity: proximity, filter: filter, sort: sort, everywhere: everywhere, denom: denom, count: count, mode: mode, indexSuggestion: indexSuggestion, suggestionType: suggestionType, dateHeureReservation: dateHeureReservation, nbPersonnesReservation: nbPersonnesReservation)
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            public typealias SuccessType = SKRResLR

            /** OK */
            case status200(SKRResLR)

            /** Internal Server Error */
            case status500(SKRException)

            public var success: SKRResLR? {
                switch self {
            ...
            public var responseResult: APIResponseResult<SKRResLR, SKRException> {
            ...
            public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
                switch statusCode {
                case 200: self = try .status200(decoder.decode(SKRResLR.self, from: data))
