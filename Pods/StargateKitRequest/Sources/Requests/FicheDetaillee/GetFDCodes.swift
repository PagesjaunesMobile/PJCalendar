...
extension StargateKitRequest.FicheDetaillee {
    ...
    /**
    Récupérer la fiche détaillée orpheline (historique, favoris ou auto-complétion) d'un professionnel

    Exemple = "/getFDCodes?codeEtab=52812250&codeAN9=54053000&codeLoc=L07505600&designationLigne=Makassar
    */
    public enum GetFDCodes {

        public static let service = APIService<Response>(id: "getFDCodes", tag: "Fiche Detaillee", method: "GET", path: "/getFDCodes", hasBody: false)
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: GetFDCodes.service)
            }
