...
extension StargateKitRequest.Utilisateurs {
    ...
    /**
    Envoyer un email de vérification d'un compte utilisateur

    <b>L'utilisateur doit être connecté au compte.</b></br></br>Exemple = "/verifyAccount
    */
    public enum VerifyAccount {

        public static let service = APIService<Response>(id: "verifyAccount", tag: "Utilisateurs", method: "GET", path: "/verifyAccount", hasBody: false)
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: VerifyAccount.service)
            }
