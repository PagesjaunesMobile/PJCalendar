...
extension StargateKitRequest.Utilisateurs {
    ...
    /**
    Prévalider le compte utilisateur

    Exemple = "/preValidateAccount
    */
    public enum PreValidateAccount {

        public static let service = APIService<Response>(id: "preValidateAccount", tag: "Utilisateurs", method: "POST", path: "/preValidateAccount", hasBody: true)
        ...
        public final class Request: APIRequest<Response> {
            ...
            public struct Options {
                ...
                public init(token: String? = nil, email: String) {
                    self.token = token
                    self.email = email
                }
            }
            ...
            public init(options: Options) {
                ...
                super.init(service: PreValidateAccount.service)
            }

            /// convenience initialiser so an Option doesn't have to be created
            public convenience init(token: String? = nil, email: String) {
