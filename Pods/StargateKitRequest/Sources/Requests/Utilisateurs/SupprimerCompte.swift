...
extension StargateKitRequest.Utilisateurs {
    ...
    <b>Supprime le compte d'un utilisateur</b><br/>Exemple = "/utilisateurs"
    */
    public enum SupprimerCompte {

        public static let service = APIService<Response>(id: "supprimerCompte", tag: "Utilisateurs", method: "DELETE", path: "/utilisateurs", hasBody: false)
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: SupprimerCompte.service)
            }
