...
extension StargateKitRequest.Utilisateurs {
    ...
    /**
    Envoyer un sms de vérification du numéro de tel d'un compte utilisateur

    <b>L'utilisateur doit être connecté au compte.</b></br></br>Exemple = "/requestSmsCode
    */
    public enum RequestSmsCode {

        public static let service = APIService<Response>(id: "requestSmsCode", tag: "Utilisateurs", method: "POST", path: "/requestSmsCode", hasBody: true)
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: RequestSmsCode.service)
            }
