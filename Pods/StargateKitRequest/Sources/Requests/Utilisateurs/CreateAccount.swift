...
extension StargateKitRequest.Utilisateurs {
    ...
    Exemple = "/createAccount
    */
    public enum CreateAccount {

        public static let service = APIService<Response>(id: "createAccount", tag: "Utilisateurs", method: "POST", path: "/createAccount", hasBody: true)
        ...
        public final class Request: APIRequest<Response> {
            ...
            public struct Options {
                ...
                public init(token: String? = nil, pseudo: String? = nil, zip: String? = nil, firstname: String? = nil, lastname: String? = nil, birthdate: String? = nil, civility: String? = nil, cgu: String? = nil, email: String? = nil, numeroMobile: String? = nil, profil: String? = nil, parcoursOrigineCreation: String? = nil, inscritNewsletter: String? = nil, password: String? = nil) {
                    self.token = token
                    self.pseudo = pseudo
                    self.zip = zip
            ...
            public init(options: Options) {
                ...
                super.init(service: CreateAccount.service)
            }

            /// convenience initialiser so an Option doesn't have to be created
            public convenience init(token: String? = nil, pseudo: String? = nil, zip: String? = nil, firstname: String? = nil, lastname: String? = nil, birthdate: String? = nil, civility: String? = nil, cgu: String? = nil, email: String? = nil, numeroMobile: String? = nil, profil: String? = nil, parcoursOrigineCreation: String? = nil, inscritNewsletter: String? = nil, password: String? = nil) {
                let options = Options(token: token, pseudo: pseudo, zip: zip, firstname: firstname, lastname: lastname, birthdate: birthdate, civility: civility, cgu: cgu, email: email, numeroMobile: numeroMobile, profil: profil, parcoursOrigineCreation: parcoursOrigineCreation, inscritNewsletter: inscritNewsletter, password: password)
