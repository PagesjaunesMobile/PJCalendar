...
extension StargateKitRequest.Utilisateurs {
    ...
    /**
    Supprimer l'avatar du compte utilisateur

    <b>Supprime l'avatar d'un utilisateur</b><br/>Exemple = "/utilisateurs/avatar"
    */
    public enum SupprimerAvatar {

        public static let service = APIService<Response>(id: "supprimerAvatar", tag: "Utilisateurs", method: "DELETE", path: "/utilisateurs/avatar", hasBody: false)
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: SupprimerAvatar.service)
            }
