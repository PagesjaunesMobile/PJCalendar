...
public struct SKRMasquableSEOElementListeOrcFDDonneesSousTitresOrcFD: StargateKitModel {
    ...
    public var valeurs: [SKRDonneesSousTitresOrcFD]?

    public init(affichageSeo: Bool? = nil, contenuSpecifiqueHebergement: Bool? = nil, contenuSpecifiqueRestaurant: Bool? = nil, typeSource: SKRTypeSource? = nil, valeurs: [SKRDonneesSousTitresOrcFD]? = nil) {
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? SKRMasquableSEOElementListeOrcFDDonneesSousTitresOrcFD else { return false }
    ...
    public static func == (lhs: SKRMasquableSEOElementListeOrcFDDonneesSousTitresOrcFD, rhs: SKRMasquableSEOElementListeOrcFDDonneesSousTitresOrcFD) -> Bool {
