...
public struct SKRResLIR: StargateKitModel {

    public var code: String?

    public var codeCI: String?

    public var list: [SKRCategory]?
    ...
    public init(code: String? = nil, codeCI: String? = nil, list: [SKRCategory]? = nil, msg: String? = nil, title: String? = nil, userId: String? = nil) {
        self.code = code
        self.codeCI = codeCI
        self.list = list
        self.msg = msg
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? SKRResLIR else { return false }
    ...
    public static func == (lhs: SKRResLIR, rhs: SKRResLIR) -> Bool {
