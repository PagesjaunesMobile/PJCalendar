...
public struct SKRResSynchronizeDraftReview: StargateKitModel {
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? SKRResSynchronizeDraftReview else { return false }
    ...
    public static func == (lhs: SKRResSynchronizeDraftReview, rhs: SKRResSynchronizeDraftReview) -> Bool {
