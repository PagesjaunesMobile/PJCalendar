...
public struct SKRResDate: StargateKitModel {
    ...
    public init(code: String? = nil, codeCI: String? = nil, date: String? = nil, msg: String? = nil, title: String? = nil, userId: String? = nil) {
        self.code = code
        self.codeCI = codeCI
        self.date = date
        self.msg = msg
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? SKRResDate else { return false }
    ...
    public static func == (lhs: SKRResDate, rhs: SKRResDate) -> Bool {
