...
public struct SKRMasquableSEOElementListeOrcFDLibelleLogoOrcFD: StargateKitModel {
    ...
    public var valeurs: [SKRLibelleLogoOrcFD]?

    public init(affichageSeo: Bool? = nil, contenuSpecifiqueHebergement: Bool? = nil, contenuSpecifiqueRestaurant: Bool? = nil, typeSource: SKRTypeSource? = nil, valeurs: [SKRLibelleLogoOrcFD]? = nil) {
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? SKRMasquableSEOElementListeOrcFDLibelleLogoOrcFD else { return false }
    ...
    public static func == (lhs: SKRMasquableSEOElementListeOrcFDLibelleLogoOrcFD, rhs: SKRMasquableSEOElementListeOrcFDLibelleLogoOrcFD) -> Bool {
