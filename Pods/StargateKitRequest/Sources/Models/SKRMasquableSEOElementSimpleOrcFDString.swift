...
public struct SKRMasquableSEOElementSimpleOrcFDString: StargateKitModel {
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? SKRMasquableSEOElementSimpleOrcFDString else { return false }
    ...
    public static func == (lhs: SKRMasquableSEOElementSimpleOrcFDString, rhs: SKRMasquableSEOElementSimpleOrcFDString) -> Bool {
