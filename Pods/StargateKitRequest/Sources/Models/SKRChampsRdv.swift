...
public struct SKRChampsRdv: StargateKitModel {
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? SKRChampsRdv else { return false }
      guard self.champ == object.champ else { return false }
      return true
    }

    public static func == (lhs: SKRChampsRdv, rhs: SKRChampsRdv) -> Bool {
