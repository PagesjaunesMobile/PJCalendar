...
public struct SKRMasquableSEOElementListeOrcFDDescriptionOrcFD: StargateKitModel {
    ...
    public var valeurs: [SKRDescription]?

    public init(affichageSeo: Bool? = nil, contenuSpecifiqueHebergement: Bool? = nil, contenuSpecifiqueRestaurant: Bool? = nil, typeSource: SKRTypeSource? = nil, valeurs: [SKRDescription]? = nil) {
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? SKRMasquableSEOElementListeOrcFDDescriptionOrcFD else { return false }
    ...
    public static func == (lhs: SKRMasquableSEOElementListeOrcFDDescriptionOrcFD, rhs: SKRMasquableSEOElementListeOrcFDDescriptionOrcFD) -> Bool {
