...
public struct SKRResPvi: StargateKitModel {
    ...
    public init(code: String? = nil, codeCI: String? = nil, msg: String? = nil, pvi: SKRPvi? = nil, title: String? = nil, userId: String? = nil) {
        self.code = code
        self.codeCI = codeCI
        self.msg = msg
        self.pvi = pvi
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? SKRResPvi else { return false }
    ...
    public static func == (lhs: SKRResPvi, rhs: SKRResPvi) -> Bool {
