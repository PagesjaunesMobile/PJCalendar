...
public struct SKRMasquableSEOElementListeOrcFDVitrineProduitsServicesOrcFD: StargateKitModel {
    ...
    public var valeurs: [SKRVitrineProduitsServicesOrcFD]?

    public init(affichageSeo: Bool? = nil, contenuSpecifiqueHebergement: Bool? = nil, contenuSpecifiqueRestaurant: Bool? = nil, typeSource: SKRTypeSource? = nil, valeurs: [SKRVitrineProduitsServicesOrcFD]? = nil) {
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? SKRMasquableSEOElementListeOrcFDVitrineProduitsServicesOrcFD else { return false }
    ...
    public static func == (lhs: SKRMasquableSEOElementListeOrcFDVitrineProduitsServicesOrcFD, rhs: SKRMasquableSEOElementListeOrcFDVitrineProduitsServicesOrcFD) -> Bool {
