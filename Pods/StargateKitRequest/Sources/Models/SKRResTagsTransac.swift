...
public struct SKRResTagsTransac: StargateKitModel {
    ...
    public init(code: String? = nil, codeCI: String? = nil, msg: String? = nil, tags: [SKRTag]? = nil, title: String? = nil, userId: String? = nil) {
        self.code = code
        self.codeCI = codeCI
        self.msg = msg
        self.tags = tags
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? SKRResTagsTransac else { return false }
    ...
    public static func == (lhs: SKRResTagsTransac, rhs: SKRResTagsTransac) -> Bool {
