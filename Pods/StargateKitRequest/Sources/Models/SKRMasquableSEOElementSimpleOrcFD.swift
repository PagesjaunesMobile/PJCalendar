...
public struct SKRMasquableSEOElementSimpleOrcFD: StargateKitModel {
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? SKRMasquableSEOElementSimpleOrcFD else { return false }
    ...
    public static func == (lhs: SKRMasquableSEOElementSimpleOrcFD, rhs: SKRMasquableSEOElementSimpleOrcFD) -> Bool {
