...
public struct SKRMasquableSEOElementListeOrcFD: StargateKitModel {
    ...
    public var valeurs: [SKRAbstractMasquableSEOElementOrcFD]?

    public init(affichageSeo: Bool? = nil, contenuSpecifiqueHebergement: Bool? = nil, contenuSpecifiqueRestaurant: Bool? = nil, typeSource: SKRTypeSource? = nil, valeurs: [SKRAbstractMasquableSEOElementOrcFD]? = nil) {
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? SKRMasquableSEOElementListeOrcFD else { return false }
    ...
    public static func == (lhs: SKRMasquableSEOElementListeOrcFD, rhs: SKRMasquableSEOElementListeOrcFD) -> Bool {
