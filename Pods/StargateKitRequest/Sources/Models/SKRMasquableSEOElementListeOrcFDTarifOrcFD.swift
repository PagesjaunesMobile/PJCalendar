...
public struct SKRMasquableSEOElementListeOrcFDTarifOrcFD: StargateKitModel {
    ...
    public var valeurs: [SKRTarifOrcFD]?

    public init(affichageSeo: Bool? = nil, contenuSpecifiqueHebergement: Bool? = nil, contenuSpecifiqueRestaurant: Bool? = nil, typeSource: SKRTypeSource? = nil, valeurs: [SKRTarifOrcFD]? = nil) {
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? SKRMasquableSEOElementListeOrcFDTarifOrcFD else { return false }
    ...
    public static func == (lhs: SKRMasquableSEOElementListeOrcFDTarifOrcFD, rhs: SKRMasquableSEOElementListeOrcFDTarifOrcFD) -> Bool {
