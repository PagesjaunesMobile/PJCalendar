...
public struct SKRMasquableSEOElementListeOrcFDHoraireOrcFD: StargateKitModel {
    ...
    public var valeurs: [SKRHoraire]?

    public init(affichageSeo: Bool? = nil, contenuSpecifiqueHebergement: Bool? = nil, contenuSpecifiqueRestaurant: Bool? = nil, typeSource: SKRTypeSource? = nil, valeurs: [SKRHoraire]? = nil) {
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? SKRMasquableSEOElementListeOrcFDHoraireOrcFD else { return false }
    ...
    public static func == (lhs: SKRMasquableSEOElementListeOrcFDHoraireOrcFD, rhs: SKRMasquableSEOElementListeOrcFDHoraireOrcFD) -> Bool {
