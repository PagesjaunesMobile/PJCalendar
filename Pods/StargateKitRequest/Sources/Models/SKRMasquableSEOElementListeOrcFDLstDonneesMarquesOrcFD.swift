...
public struct SKRMasquableSEOElementListeOrcFDLstDonneesMarquesOrcFD: StargateKitModel {
    ...
    public var valeurs: [SKRLstDonneesMarquesOrcFD]?

    public init(affichageSeo: Bool? = nil, contenuSpecifiqueHebergement: Bool? = nil, contenuSpecifiqueRestaurant: Bool? = nil, typeSource: SKRTypeSource? = nil, valeurs: [SKRLstDonneesMarquesOrcFD]? = nil) {
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? SKRMasquableSEOElementListeOrcFDLstDonneesMarquesOrcFD else { return false }
    ...
    public static func == (lhs: SKRMasquableSEOElementListeOrcFDLstDonneesMarquesOrcFD, rhs: SKRMasquableSEOElementListeOrcFDLstDonneesMarquesOrcFD) -> Bool {
