...
public struct SKRResCtx: StargateKitModel {
    ...
    public init(ad: SKRAdv? = nil, code: String? = nil, codeCI: String? = nil, count: String? = nil, countG: String? = nil, cqlr: SKRCqlr? = nil, degLev: String? = nil, historisable: Bool? = nil, list: [SKRList]? = nil, maxBlocP: String? = nil, msg: String? = nil, page: String? = nil, pageCount: String? = nil, queryId: String? = nil, reformulations: SKRReformulationsStargate? = nil, researchId: String? = nil, seReferencer: SKRSeReferencer? = nil, search: SKRSearchLr? = nil, searchId: String? = nil, sessionId: String? = nil, suggestions: SKRSuggestionsStargate? = nil, title: String? = nil, token: String? = nil, topLabel: String? = nil, userId: String? = nil) {
        self.ad = ad
        self.code = code
        self.codeCI = codeCI
        self.count = count
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? SKRResCtx else { return false }
    ...
    public static func == (lhs: SKRResCtx, rhs: SKRResCtx) -> Bool {
