...
public struct SKRResDeleteUserAccount: StargateKitModel {
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? SKRResDeleteUserAccount else { return false }
    ...
    public static func == (lhs: SKRResDeleteUserAccount, rhs: SKRResDeleteUserAccount) -> Bool {
