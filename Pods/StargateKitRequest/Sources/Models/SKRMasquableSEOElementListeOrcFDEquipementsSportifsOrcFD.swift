...
public struct SKRMasquableSEOElementListeOrcFDEquipementsSportifsOrcFD: StargateKitModel {
    ...
    public var valeurs: [SKREquipementsSportifsOrcFD]?

    public init(affichageSeo: Bool? = nil, contenuSpecifiqueHebergement: Bool? = nil, contenuSpecifiqueRestaurant: Bool? = nil, typeSource: SKRTypeSource? = nil, valeurs: [SKREquipementsSportifsOrcFD]? = nil) {
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? SKRMasquableSEOElementListeOrcFDEquipementsSportifsOrcFD else { return false }
    ...
    public static func == (lhs: SKRMasquableSEOElementListeOrcFDEquipementsSportifsOrcFD, rhs: SKRMasquableSEOElementListeOrcFDEquipementsSportifsOrcFD) -> Bool {
