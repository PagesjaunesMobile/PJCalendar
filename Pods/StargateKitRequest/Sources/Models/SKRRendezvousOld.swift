...
public struct SKRRendezvousOld: StargateKitModel {
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? SKRRendezvousOld else { return false }
      guard self.rdv == object.rdv else { return false }
      return true
    }

    public static func == (lhs: SKRRendezvousOld, rhs: SKRRendezvousOld) -> Bool {
