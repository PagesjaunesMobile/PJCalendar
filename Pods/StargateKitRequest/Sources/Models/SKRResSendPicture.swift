...
public struct SKRResSendPicture: StargateKitModel {
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? SKRResSendPicture else { return false }
    ...
    public static func == (lhs: SKRResSendPicture, rhs: SKRResSendPicture) -> Bool {
