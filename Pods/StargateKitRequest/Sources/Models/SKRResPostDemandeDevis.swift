...
public struct SKRResPostDemandeDevis: StargateKitModel {
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? SKRResPostDemandeDevis else { return false }
    ...
    public static func == (lhs: SKRResPostDemandeDevis, rhs: SKRResPostDemandeDevis) -> Bool {
