...
public struct SKRMasquableSEOElementListeOrcFDCapaciteAccueilOrcFD: StargateKitModel {
    ...
    public var valeurs: [SKRCapaciteAccueil]?

    public init(affichageSeo: Bool? = nil, contenuSpecifiqueHebergement: Bool? = nil, contenuSpecifiqueRestaurant: Bool? = nil, typeSource: SKRTypeSource? = nil, valeurs: [SKRCapaciteAccueil]? = nil) {
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? SKRMasquableSEOElementListeOrcFDCapaciteAccueilOrcFD else { return false }
    ...
    public static func == (lhs: SKRMasquableSEOElementListeOrcFDCapaciteAccueilOrcFD, rhs: SKRMasquableSEOElementListeOrcFDCapaciteAccueilOrcFD) -> Bool {
