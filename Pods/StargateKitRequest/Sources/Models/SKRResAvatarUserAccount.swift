...
public struct SKRResAvatarUserAccount: StargateKitModel {
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? SKRResAvatarUserAccount else { return false }
    ...
    public static func == (lhs: SKRResAvatarUserAccount, rhs: SKRResAvatarUserAccount) -> Bool {
