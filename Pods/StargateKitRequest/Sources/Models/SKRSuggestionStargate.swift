...
public struct SKRSuggestionStargate: StargateKitModel {
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? SKRSuggestionStargate else { return false }
    ...
    public static func == (lhs: SKRSuggestionStargate, rhs: SKRSuggestionStargate) -> Bool {
