...
public struct SKRMasquableSEOElementListeOrcFDCategorieCritereRechercheOrcFD: StargateKitModel {
    ...
    public var valeurs: [SKRCritereRecherche]?

    public init(affichageSeo: Bool? = nil, contenuSpecifiqueHebergement: Bool? = nil, contenuSpecifiqueRestaurant: Bool? = nil, typeSource: SKRTypeSource? = nil, valeurs: [SKRCritereRecherche]? = nil) {
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? SKRMasquableSEOElementListeOrcFDCategorieCritereRechercheOrcFD else { return false }
    ...
    public static func == (lhs: SKRMasquableSEOElementListeOrcFDCategorieCritereRechercheOrcFD, rhs: SKRMasquableSEOElementListeOrcFDCategorieCritereRechercheOrcFD) -> Bool {
