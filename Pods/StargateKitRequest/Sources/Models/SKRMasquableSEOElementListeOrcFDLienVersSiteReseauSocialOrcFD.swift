...
public struct SKRMasquableSEOElementListeOrcFDLienVersSiteReseauSocialOrcFD: StargateKitModel {
    ...
    public var valeurs: [SKRLienVersSiteReseauSocialOrcFD]?

    public init(affichageSeo: Bool? = nil, contenuSpecifiqueHebergement: Bool? = nil, contenuSpecifiqueRestaurant: Bool? = nil, typeSource: SKRTypeSource? = nil, valeurs: [SKRLienVersSiteReseauSocialOrcFD]? = nil) {
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? SKRMasquableSEOElementListeOrcFDLienVersSiteReseauSocialOrcFD else { return false }
    ...
    public static func == (lhs: SKRMasquableSEOElementListeOrcFDLienVersSiteReseauSocialOrcFD, rhs: SKRMasquableSEOElementListeOrcFDLienVersSiteReseauSocialOrcFD) -> Bool {
