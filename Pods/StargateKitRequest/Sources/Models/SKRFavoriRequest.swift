...
public struct SKRFavoriRequest: StargateKitModel {
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? SKRFavoriRequest else { return false }
    ...
    public static func == (lhs: SKRFavoriRequest, rhs: SKRFavoriRequest) -> Bool {
