...
public struct SKRMasquableSEOElementListeOrcFDLienTransactionnelApiInscriptionOrcFD: StargateKitModel {
    ...
    public var valeurs: [SKRLienTransactionnelApiInscriptionOrcFD]?

    public init(affichageSeo: Bool? = nil, contenuSpecifiqueHebergement: Bool? = nil, contenuSpecifiqueRestaurant: Bool? = nil, typeSource: SKRTypeSource? = nil, valeurs: [SKRLienTransactionnelApiInscriptionOrcFD]? = nil) {
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? SKRMasquableSEOElementListeOrcFDLienTransactionnelApiInscriptionOrcFD else { return false }
    ...
    public static func == (lhs: SKRMasquableSEOElementListeOrcFDLienTransactionnelApiInscriptionOrcFD, rhs: SKRMasquableSEOElementListeOrcFDLienTransactionnelApiInscriptionOrcFD) -> Bool {
